...
python -u main.py --overwrite  --meta_model warp_leap_fixed --suffix testrun.fixed.2 --fixed_warp_layer_sz 2 --meta_train_steps 600 --outer_kwargs 'lr' 0.3  &> warp_leap_fixed_testrun_2layers.600.olr=0.3.txt
